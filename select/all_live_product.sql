...
where rp.acceptation = 1 and  p.sold = 0 and pimag.IMAGE_ID = 1 and d.percentage_id = 1 and ap.acceptation = 1 and p.pay_way_id = (SELECT pay_way_id FROM pay_way where pay_way_name = 'Live Auction');
...
LEFT JOIN accept_particpation ap
ON d.deposite_id = ap.deposite_id
where rp.acceptation = 1 and  p.sold = 0 and pimag.IMAGE_ID = 1 and d.percentage_id = 1 and ap.acceptation = 1 and c.category_id = (select category_id from category where category_name = 'Cars') and p.pay_way_id = (SELECT pay_way_id FROM pay_way where pay_way_name = 'Live Auction');
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
