--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
select p.product_id, a.auction_id,p.product_name as title ,pimag.image as image , p.product_price as price, a.initial_price as price , p.product_brand 
...
where rp.acceptation = 1 and  p.sold = 0 and pimag.IMAGE_ID = 1 and (d.percentage_id = 1 or d.percentage_id is null) and (ap.acceptation = 1 or ap.acceptation is null);
...
LEFT JOIN accept_particpation ap
ON d.deposite_id = ap.deposite_id
where rp.acceptation = 1 and  p.sold = 0 and pimag.IMAGE_ID = 1 and (d.percentage_id = 1 or d.percentage_id is null) and (ap.acceptation = 1 or ap.acceptation is null) and c.category_id = (select category_id from category where category_name = 'Cars');
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------