--select for all schedule auction with all image of each schedule auction product it's not sold
...
where p.pay_way_id = 3 and rp.acceptation = 1 and p.sold = 0;
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

--select for all schedule auction with first image of each schedule auction product
...
INNER JOIN review_product rp
ON rp.product_id = p.product_id
where p.pay_way_id = 3 and rp.acceptation = 1 and pimag.image_id = 1;
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

--select for all schedule auction with first image of each schedule auction product and the bider in this auction
...
WHERE p.product_id = a.auction_id and p.pay_way_id = 3 and pimag.image_id = 1 ;
